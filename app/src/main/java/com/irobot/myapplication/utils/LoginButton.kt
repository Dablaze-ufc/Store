...
class LoginButton : View {
    ...
    private var onSignInListener: OnLoginListener? = null
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        loginTextOutline!!.offset(
            dWidth / 2 - (loginTextOutline!!.right
                    + loginTextOutline!!.left) / 2, dpToPixels(457).toInt()
        )

        signUpTextOutline!!.offset(
            dWidth / 2 - (signUpTextOutline!!.right
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (isLogin) {
            ...
            canvas.drawText(
                getString(R.string.sign_in), (dWidth / 2).toFloat(),
        ...
        if (isLogin) {
            ...
            canvas.drawText(
                getString(R.string.or), signUpOrX,
                buttonCenter + dpToPixels(8), orPaint!!
            )

            canvas.drawText(
                getString(R.string.sign_up), currentSignUpTextX,
